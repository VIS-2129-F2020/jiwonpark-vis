---
title: "VIS_interactive_assignment"
author: "Jiwon Park"
date: '2020 10 23 '
...
```{r}
  ...
  paste("Date of Designation :" ,
        case_when(landmark_boston_addr$Date_Desig == " " ~ "NA",
                  TRUE ~ landmark_boston_addr$Date_Desig)) %>%
  lapply(htmltools::HTML)
```


```{r}
map1 <- colorNumeric(palette = "viridis", 
...
```{r}
saveWidget(map1[3][[1]], file = "map1.html")
```
